...
public class MainActivity extends AppCompatActivity {
    ...
    private Button undo;
    private String userWords; // whatever the user has in the layouts until this point
    ...
    public boolean onStartGame(View view) {
        ...
        // Getting random words from the dictionary
        int index1, index2;
        ...
        for (counter1 = 0, counter2 = 0;
             counter1< WORD_LENGTH && counter2 < WORD_LENGTH;) {
        ...
        Log.d("MainActivity", String.valueOf(scrambledWord));

        LetterTile[]  letterTiles = new LetterTile[2 * WORD_LENGTH];
        for (counter1 = 0, counter2 = scrambledWord.length() - 1;
             counter1 < 2 * WORD_LENGTH; counter1++, counter2--) {
            letterTiles[counter1] = new LetterTile(this,
                    scrambledWord.charAt(counter2));
